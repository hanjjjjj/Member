        ...
        <div class="container site-section pb-0">
            ...
            <div class="item player">
                <div style="text-align: center;">
                    ...
                    <a href="#"><img src="/resources/css2/images/pu.png" alt="Image" class="img-fluid"width="624px" height="624px"></a>
                    <div class="p-4">
                        <h3>Puskás Ferenc</h3>
                        <p>#10 / Forward</p>
                        <p>
                            1958 Real Madrid CF ~ 1966 Real Madrid CF
                        </p>
                        <p>Laliga 4 winner ,UEFA CUP 3 winner, Copa del Rey 1 winner, Intercontinental Cup 1 winner</p>
                        <p>Ballon d'Or 2rd 1960, LaLiga top scorer 1959-64 </p>
                    </div>
                </div>
            </div>
        </div>
