        ...
        <div class="container site-section pb-0">
            ...
            <div class="item player">
                <div style="text-align: center;">
                    ...
                    <a href="#"><img src="/resources/css2/images/Ro.png" alt="Image" class="img-fluid"width="624px" height="624px"></a>
                    <div class="p-4">
                        <h3>Roberto Carlos</h3>
                        <p>#3 / defender</p>
                        <p>
                            1996 Real Madrid CF ~ 2007 Real Madrid CF
                        </p>
                        <p>Laliga 4 winner UEFA Champions League 3 winner, UEFA Super Cup winner 1,  Intercontinental Cup 2 winner, Supercopa de España 3 winner</p>
                        <p>Ballon d'Or 2rd 2002, UEFA Team of the Year 2002~2003 Onze de Onze 1997~2005 </p>
                    </div>
                </div>
            </div>
        </div>
