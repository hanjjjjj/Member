        ...
        <div class="container site-section pb-0">
            ...
            <div class="item player">
                <div style="text-align: center;">
                    ...
                    <a href="#"><img src="/resources/css2/images/destapano.png" alt="Image" class="img-fluid"width="624px" height="624px"></a>
                    <div class="p-4">
                        <h3>Alfredo Stéfano di Stéfano</h3>
                        <p>#9 / Forward</p>
                        <p>
                            Real Madrid CF (1953~1964)
                        </p>
                        <p>Laliga 8 winner ,European Cup 5 winner, Copa del Rey 1 winner</p>
                        <p> Ballon d'Or 1957-1959 LaLiga top scorer 1953~1959</p>
                    </div>
                </div>
            </div>
        </div>
