        ...
        <div class="container site-section pb-0">
            ...
            <div class="item player">
                <div style="text-align: center;">
                    ...
                    <a href="#"><img src="/resources/css2/images/Bo.png" alt="Image" class="img-fluid"width="624px" height="624px"></a>
                    <div class="p-4">
                        <h3>Emilio Butragueño</h3>
                        <p>#7 / Forward</p>
                        <p>
                            1981 Real Madrid CF ~ 1995 Real Madrid CF
                        </p>
                        <p>Laliga 5 winner ,UEFA CUP 2 winner, Copa del Rey 2 winner, Supercopa de España 4 winner</p>
                        <p>Ballon d'Or 3rd 1986-1987, FIFA WORLD CUP silver shoe 1986 LaLiga top scorer 1990-37 </p>
                    </div>
                </div>
            </div>
        </div>
